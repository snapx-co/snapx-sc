...
import { TxnapJetton, storeMint } from "../build/SnapX/tact_TxnapJetton";
...
export async function run(provider: NetworkProvider) {
    ...
    const TonClient = provider.open(deployer_wallet);

    const jettonParams = {
        name: "TxnapJetton",
        description: "SnapX Jetton",
        symbol: "TXNAP",
    ...
    let init = await TxnapJetton.init(deployer_wallet_contract.address, content, max_supply);
